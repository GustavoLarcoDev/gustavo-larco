        ...
        <>
            ...
            <div className="grid items-center justify-center h-screen max-w-5xl gap-6 mx-auto md:grid-cols-2">
                <div className="max-w-[450px]">
                    ...
                    <p className="mb-3 text-xl text-gray-300">Please for any information or request for collaborations in projects, work and any kind of services, do not hessitate to contact me at the next ways.</p>
                </div>
